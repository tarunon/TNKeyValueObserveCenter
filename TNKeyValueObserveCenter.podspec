...
Pod::Spec.new do |s|
  ...
  # s.description  = <<-DESC
  #                 A longer description of TNKeyValueObserveCenter in Markdown format.
  #
  ...
  # Or just: s.author    = "tarunon"
  # s.authors            = { "tarunon" => "croissant9603@gmail.com" }
  # s.social_media_url   = "http://twitter.com/tarunon"
